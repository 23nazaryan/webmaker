                ...
                <div class="col-md-8">
                    ...
                    <article class="post">
                        <div class="post-thumb">
                            <a href="javascript:;"><img src="{{$post->getImage()}}" alt=""></a>
                        </div>
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                ...
                                <h1 class="entry-title"><a href="javascript:;">{{$post->title}}</a></h1>
                            </header>
							...
							<span
                                class="social-share-title pull-left text-capitalize">By {{$post->author ? $post->author->name : ''}} On {{$post->getDate()}}</span>
